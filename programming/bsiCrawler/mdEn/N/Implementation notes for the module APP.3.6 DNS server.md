...
* If enough trained personnel already exist for a particular product and all functionality requirements are met, this DNS server product should be used.
