...
In order to achieve the required level of security, outsourcing customers and outsourcing service providers should jointly develop security goals and security requirements based on them, which take into account the individuality of the respective outsourcing project.
