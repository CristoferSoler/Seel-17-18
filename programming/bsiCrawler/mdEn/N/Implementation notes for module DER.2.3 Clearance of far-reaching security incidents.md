...
When screening out IT systems used to monitor the attacker or for forensic analysis, it is important to ensure the secure deletion or destruction of all storage media, as they usually contain sensitive data. In addition, it may be necessary to check whether forensic data must be securely archived in order to allow for further follow-up examinations or to secure evidence as evidence.
