...
### 2 6 Non-compliance with safety measuresFor a variety of reasons, such as carelessness or rush, it can happen that so confidential documents at workplaces lying open, escape doors can be opened from both sides or emails are not encrypted. This can cause damage that would otherwise be prevented or at least reduced.
...
In the "boss trick" - the English term is CEO Fraud - is a fictitious order of the boss is fooled by clerks who are allowed to transfer money on behalf of the company. They are to carry out transactions for an allegedly urgent and secretive business, which are extremely important for the further existence of the enterprise. In the course of 2016, fraudsters managed to damage thousands of companies in the six- to eight-digit range in thousands of companies. The damage worldwide is in the billions.
...
* G 0.32 Abuse of permissions* G 0.36 Identity theft
