...
If access controls are lacking or insufficient, unauthorized persons can enter an office room and steal sensitive data, steal devices or manipulate them. This may affect the availability, confidentiality, or integrity of devices and information. Even if no direct damage can be detected, the operation can be disrupted by the fact that it must be investigated how such an incident was possible, whether damage occurred or tampering was carried out.
