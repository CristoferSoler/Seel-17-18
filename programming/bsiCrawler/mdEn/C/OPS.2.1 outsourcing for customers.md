...
The outsourcing partners SHOULD regularly carry out joint exercises and tests to maintain the safety level. Information about security risks and how to deal with them SHOULD be exchanged on a regular basis between the outsourcing partners. There SHOULD exist a process that ensures the flow of information in dealing with security incidents affecting the respective contractors.
