...
The module APP.5.1 Groupware is mostly used in an information network in connection with another specific module of the layer APP.1 E-Mail / Groupware / Communication, these must also be implemented separately. These building blocks include APP.1.2 Microsoft Exchange / Outlook, APP.1.3 Kontact, APP.1.4 Lotus Notes / Domino and APP.1.5 Instant Messaging.
