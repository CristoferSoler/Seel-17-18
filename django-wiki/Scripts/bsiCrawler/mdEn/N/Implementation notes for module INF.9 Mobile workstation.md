...
When working on the move, you need to be careful not only about the IT systems that you take along (for example, laptops, smartphones, or tablets), but also about the information you have processed on the go. For example, the work environment regulations provided by the employer should be complied with and the work materials should be kept secure (see INF.9.M3 * Access and Access Protection * and INF.9.M4 * Working with Third-Party IT Systems). *
...
In some cases, for example in open-plan offices, the doors can not be locked. Then, as an alternative, each employee should close his / her records (according to the clean-desk policy) and personal workspace before leaving home. These include, for example, the desk, cupboard, client, laptop and the telephone.
