...
In the case of tenders or the selection of an outsourcing service provider, a service description or a specification should always be created with the following contents:
...
+ what availability is guaranteed, how often, for example, to read e-mails and how fast they are to answer
...
* The applicable security concepts of all parties involved must be checked to see whether they are still compatible and guarantee the desired level of security. In particular, the outsourcing service provider should inform outsourcing customers about important changes in their sphere of influence.
