...
An information security training program should provide employees with all the information and skills needed to implement security policies and measures in place within the institution.
...
In the following, a structure and important contents of training modules are presented by way of example, which, according to the aspects presented, still have to be prepared in terms of roles and resources. For many areas, training offers from appropriate providers are available if internal planning and implementation in the institution is not possible.
...
+ Controls on computer workstations
...
This training module should provide the basics for establishing and maintaining an emergency management in the institution. Thematically it represents an advanced course to the module 5 "risk management". The training contents can be built up according to the structure of the BSI standard 100-4.
...
Another way of assessing whether a measure was successful is to count the number of rule violations before and after the sensitization measures. In addition, responsible persons can place consciously and controlled security gaps and observe how coworkers handle it. For example:
