...
The functional scope and the supply of functional changes of a Windows 10 version MUST be selected taking into account the identified protection needs and the purpose of use and the feasibility of the required safeguards must be checked. Based on the result of the review, the established procurement process MUST be extended to include the appropriate license model and release path (CB, CBB or LTSB).
