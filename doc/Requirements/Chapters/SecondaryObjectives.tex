...
\section{Information Pages - Priority: MEDIUM}
\begin{itemize}
\item Information page is a page, in form of a tab, that is located next to the FAQ tab. By clicking on the FAQ in the home page, the user have the possibility to reach this tab.
...
\item This page could contain different questions about different topics from different users of the page.
\item The content of an information page is to be kept online for just one month to give the users enough time to answer.
\item To allow a flowing discussion, the content in the information page doesn’t need to be approved by a moderator before being published, taking in count that users not obeying the roles of the wiki should be banned or at least get a warning.
\end{itemize}

\subsection{Benefits}
\begin{itemize}
\item The main idea behind information page is to allow the users to ask questions about the usability of specific component in our page, which is not clear enough for the users.
